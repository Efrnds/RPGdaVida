...
export default function Option({ imgPath, text, href }) {
  return (
    ...
    >
      <img src={imgPath} alt="" className="m-auto h-16 md:h-28 transition-transform duration-150 group-hover:scale-[1.02]" />
      <p className="text-[11px] md:text-sm font-semibold leading-tight text-center text-grayMd">{text}</p>
    </Link>
  );
}
